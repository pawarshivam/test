...
module.exports = __webpack_require__(/*! C:\Users\Shivam\Desktop\Air\admin\src\main.ts */"zUnb");
...
BreakPointsService.ɵfac = function BreakPointsService_Factory(t) { return new (t || BreakPointsService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_cdk_layout__WEBPACK_IMPORTED_MODULE_1__["BreakpointObserver"])); };
...
class OrgService {
    constructor($api, $authentication, config) {
        this.$api = $api;
    ...
    uploadLogo(logo) {
        ...
        fd.append('file', logo);
        return this.$api.upload(fd, '/logo').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])((result) => {
            this.$lrt = this.$lrt + 1;
            return result;
        }));
    }
    uploadWallpaper(wallpaper) {
        ...
        return this.$api.upload(fd, '/wallpaper').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_0__["map"])((result) => {
            this.$wrt = this.$wrt + 1;
            return result;
        }));
    }
    get logoPath() {
        var _a;
        const org = (_a = this.$authentication.user) === null || _a === void 0 ? void 0 : _a.org;
        if (org) {
...
class ApiService {
    ...
    post(route, data) {
        ...
        return this.$http.post(`${this.config.api.url}${route}`, data, {
    ...
    put(route, data) {
        ...
        return this.$http.put(`${this.config.api.url}${route}`, data, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"](this.headers),
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((result) => ({
            status: 200,
            data: result.data,
    ...
    patch(route, data) {
        ...
        return this.$http.patch(`${this.config.api.url}${route}`, data, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"](this.headers),
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((result) => ({
            status: 200,
            data: result.data,
    ...
    delete(route) {
        ...
        return this.$http.delete(`${this.config.api.url}${route}`, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"](this.headers),
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((result) => ({
            status: 200,
            data: result.data,
    ...
    get(route) {
        ...
        return this.$http.get(`${this.config.api.url}${route}`, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"](this.headers),
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((result) => ({
            status: 200,
            data: result.data,
    ...
    upload(fd, route) {
        ...
        return this.$http.post(`${this.config.api.url}${route}`, fd, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"](this.headers),
        }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])((result) => ({
            status: 200,
            data: result.data,
...
ApiService.ɵfac = function ApiService_Factory(t) { return new (t || ApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵinject"](_services_config_service__WEBPACK_IMPORTED_MODULE_4__["ConfigService"])); };
...
function CSVComponent_p_8_Template(rf, ctx) { if (rf & 1) {
...
class CSVComponent {
    constructor(data, $dialog, $snackBar) {
        this.data = data;
        this.$dialog = $dialog;
    ...
    copyLink() {
        navigator.clipboard.writeText(this.data.path).then((result) => {
...
CSVComponent.ɵfac = function CSVComponent_Factory(t) { return new (t || CSVComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_0__["MAT_DIALOG_DATA"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_0__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_2__["MatSnackBar"])); };
CSVComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: CSVComponent, selectors: [["app-csv"]], decls: 14, vars: 2, consts: [["mat-dialog-title", "", 1, "mat-h1"], ["mat-dialog-content", ""], [1, "csv-link"], [1, "sse-container"], ["class", "sse", 4, "ngIf"], ["mat-dialog-actions", ""], ["mat-button", "", "cdkFocusInitial", "", 3, "click"], ["mat-button", "", 3, "click"], [1, "sse"]], template: function CSVComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CSVComponent_Template_button_click_10_listener() { return ctx.copyLink(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](11, "Copy Link");
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](12, "button", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function CSVComponent_Template_button_click_12_listener() { return ctx.openLink(); });
...
/* harmony import */ var _services_config_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @services/config.service */ "r4Kj");
/* harmony import */ var _services_breakpoints_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @services/breakpoints.service */ "2/li");
/* harmony import */ var _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/material/sidenav */ "XhcP");
/* harmony import */ var _app_navigation_navigation_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @app/navigation/navigation.component */ "k5x5");
...
function AppComponent_ng_container_11_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_ng_container_11_Template_button_click_13_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.signOut(); });
...
class AppComponent {
    constructor($authentication, $snackBar, $router, config, breakpoints) {
        this.$authentication = $authentication;
        this.$snackBar = $snackBar;
        this.$router = $router;
        this.config = config;
        ...
        this.$authentication.authenticated.subscribe((result) => {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 22, vars: 6, consts: [[3, "mode", "opened"], ["drawer", ""], [1, "bg-dotted"], [1, "bg-header"], [1, "mat-elevation-z"], ["src", "assets/images/logo.png", "width", "38px", "height", "38px", 3, "click"], [3, "click"], [1, "spacer"], [4, "ngIf"], [1, "container"], [1, "row"], [1, "col-12"], [1, "mat-h2"], ["mat-icon-button", "", 3, "matMenuTriggerFor"], ["src", "assets/images/user.svg", "width", "24px"], ["mprofile", "matMenu"], [1, "profile", 3, "ngStyle"], [1, "name"], ["mat-menu-item", "", "routerLink", "/profile"], ["mat-menu-item", "", "routerLink", "/home"], ["mat-menu-item", "", 3, "click"], ["mat-button", "", "routerLink", "authentication/sign-in"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_img_click_7_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](2); return _r0.toggle(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](8, "span", 6);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function AppComponent_Template_span_click_8_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r6); const _r0 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](2); return _r0.toggle(); });
...
/* harmony import */ var _app_app_routing_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @app/app-routing.module */ "vY5A");
/* harmony import */ var _app_app_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @app/app.component */ "Sy1n");
...
/* harmony import */ var _app_navigation_navigation_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @app/navigation/navigation.component */ "k5x5");
...
/* harmony import */ var _app_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! @app/confirm/confirm.component */ "kOC7");
/* harmony import */ var _app_csv_csv_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @app/csv/csv.component */ "OjzY");
...
const config = { url: 'http://air-vms.com:8000', options: {} };
class AppModule {
}
AppModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_20__["ɵɵdefineNgModule"]({ type: AppModule, bootstrap: [_app_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"]] });
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_20__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_app_component__WEBPACK_IMPORTED_MODULE_2__["AppComponent"],
        _app_navigation_navigation_component__WEBPACK_IMPORTED_MODULE_13__["NavigationComponent"],
        _app_confirm_confirm_component__WEBPACK_IMPORTED_MODULE_17__["ConfirmComponent"],
        _app_csv_csv_component__WEBPACK_IMPORTED_MODULE_18__["CSVComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_app_routing_module__WEBPACK_IMPORTED_MODULE_1__["AppRoutingModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_3__["BrowserAnimationsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
        _angular_material_sidenav__WEBPACK_IMPORTED_MODULE_6__["MatSidenavModule"],
        ...
        _angular_material_form_field__WEBPACK_IMPORTED_MODULE_15__["MatFormFieldModule"],
        _angular_material_input__WEBPACK_IMPORTED_MODULE_16__["MatInputModule"],
        _angular_material_card__WEBPACK_IMPORTED_MODULE_5__["MatCardModule"], ngx_socket_io__WEBPACK_IMPORTED_MODULE_19__["SocketIoModule"]] }); })();
...
class AuthenticationService {
    constructor($api, $router, config) {
        ...
        if (token) {
            try {
                ...
                this.verifyUser().subscribe((result) => {
                }, (error) => {
                    this.detox();
                    this.$router.navigate(['/home']);
                });
    ...
    signOut() {
        return this.$api.post('/user/sign-out', {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((result) => {
            this.detox();
            return result;
        }));
    }
    uploadProfile(profile) {
        ...
        return this.$api.upload(fd, '/profile').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["map"])((result) => {
            this.$rt = this.$rt + 1;
            return result;
        }));
    }
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _services_authentication_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @services/authentication.service */ "ej43");
/* harmony import */ var _services_org_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @services/org.service */ "46RQ");
...
function NavigationComponent_ng_container_10_mat_nav_list_8_Template(rf, ctx) { if (rf & 1) {
...
class NavigationComponent {
    constructor($authentication, $org, config) {
        this.$authentication = $authentication;
        this.$org = $org;
        this.config = config;
    }
    ...
    get admin() {
        ...
        if (this.$authentication.authenticated.getValue()) {
            ...
            if (role) {
                if (this.config.role.ra == role.id
                    ||
...
ConfirmComponent.ɵfac = function ConfirmComponent_Factory(t) { return new (t || ConfirmComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_0__["MAT_DIALOG_DATA"])); };
ConfirmComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ConfirmComponent, selectors: [["app-confirm"]], decls: 10, vars: 4, consts: [["mat-dialog-title", "", 1, "mat-h1"], ["mat-dialog-content", ""], ["mat-dialog-actions", ""], ["mat-button", "", "cdkFocusInitial", "", 3, "mat-dialog-close"], ["mat-button", "", 3, "mat-dialog-close"]], template: function ConfirmComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](0, "h1", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵtext"](1);
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelementStart"](2, "div", 1);
...
const routes = [
    ...
    {
        path: 'home', loadChildren: () => __webpack_require__.e(/*! import() | home-home-module */ "home-home-module").then(__webpack_require__.bind(null, /*! @home/home.module */ "ct+p")).then(module => module.HomeModule),
    },
    {
        path: 'authentication', loadChildren: () => __webpack_require__.e(/*! import() | authentication-authentication-module */ "authentication-authentication-module").then(__webpack_require__.bind(null, /*! @authentication/authentication.module */ "OpKh")).then(module => module.AuthenticationModule),
    },
    {
        path: 'dashboard', loadChildren: () => Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("default~admin-agendas-agendas-module~admin-feedbacks-feedbacks-module~admin-org-org-module~admin-use~f5d435ee"), __webpack_require__.e("common"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! @dashboard/dashboard.module */ "TDBs")).then(module => module.DashboardModule),
    },
    {
        path: 'profile', loadChildren: () => Promise.all(/*! import() | profile-profile-module */[__webpack_require__.e("default~admin-agendas-agendas-module~admin-feedbacks-feedbacks-module~admin-org-org-module~authentic~5ed2fa36"), __webpack_require__.e("default~admin-feedbacks-feedbacks-module~admin-users-users-module~admin-visitors-visitors-module~pro~aa160e34"), __webpack_require__.e("default~authentication-sign-in-sign-in-module~profile-profile-module"), __webpack_require__.e("common"), __webpack_require__.e("profile-profile-module")]).then(__webpack_require__.bind(null, /*! @profile/profile.module */ "cRhG")).then(module => module.ProfileModule),
    },
    {
        path: 'admin', loadChildren: () => __webpack_require__.e(/*! import() | admin-admin-module */ "admin-admin-module").then(__webpack_require__.bind(null, /*! @admin/admin.module */ "jkDv")).then(module => module.AdminModule),
    },
];
